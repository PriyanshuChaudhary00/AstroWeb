    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-primary">
        ...
        <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6" data-testid="text-about-title">
            ...
            {achievements.map((achievement, index) => (
              <Card key={index} className="text-center" data-testid={`card-achievement-${index}`}>
                <CardContent className="p-8">
                  ...
                  <p className="text-3xl font-bold text-accent mb-2" data-testid={`text-value-${index}`}>
                    {achievement.value}
                  </p>
      ...
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4" data-testid="badge-mission">Our Mission</Badge>
              <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6" data-testid="text-mission-title">
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4" data-testid="text-values-title">
              Our Core Values
            </h2>
